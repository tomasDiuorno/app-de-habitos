...
public class ServicioEvaluadorCheckTest {
  ...
  public void init() {
    ...
    servicioEvaluadorCheck = new ServicioEvaluadorCheckImpl(servicioIAMock);
  }
  ...
  public void dadoQueLaImagenCumpleCuandoLaIARespondeSiEntoncesElHabitoSeCompleta()
    ...
    verify(servicioIAMock)
      .evaluarImagen(anyString(), eq("Ir al gimnasio"), eq("Entrenar"), eq("image/jpeg"));
  }
