...
public class EvaluadorHabitosFactoryTest {
    ...
    public void dadoUnTipoHabitoSinEvaluador_cuandoObtengoElEvaluador_entoncesLanzaUnaExcepcion() {
        ...
        // When
        IllegalArgumentException excepcion = assertThrows(IllegalArgumentException.class, () -> factory.obtener(TipoHabitoEnum.CANTIDAD));

        // Then
        assertThat(excepcion.getMessage(), is("No se encontró un evaluador para el tipo de hábito: CANTIDAD"));
    }
}
