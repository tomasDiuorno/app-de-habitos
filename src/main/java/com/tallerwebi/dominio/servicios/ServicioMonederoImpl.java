...
public class ServicioMonederoImpl implements ServicioMonedero {
  ...
  public void acreditarPorRecompensa(Usuario usuario) {
    acreditarMonedas(usuario, MONEDAS_POR_RECOMPENSA, "RECOMPENSA", "Recompensa obtenida");
  }

  @Override
  public void acreditarMonedas(Usuario usuario, Integer monto, String tipo, String descripcion) {
    if (monto <= 0) return;
  ...
  public List<Transaccion> obtenerTransacciones(Usuario usuario) {
    ...
    return new ArrayList<>(monedero.getTransacciones());
  }
}
